...
public class LogicalStability {
    ...
    public static void main(final String[] args) {
        // * 🚩最初的测试NAL
        final StringBuilder TEST_LINES = new StringBuilder(NAL_LINES);
        // * 🚩添加尽可能多的「多样化场景」
        for (final String copula : new String[] {
                SIMILARITY_RELATION, IMPLICATION_RELATION, EQUIVALENCE_RELATION,
                INSTANCE_RELATION, PROPERTY_RELATION, INSTANCE_PROPERTY_RELATION
        }) {
            TEST_LINES.append("\n" + NAL_LINES.replaceAll(INHERITANCE_RELATION, copula));
        }
        for (final String operator : new String[] {
            ...
            TEST_LINES.append("\n" + NAL_LINES.replaceAll(CONJUNCTION_OPERATOR, operator));
        }
        // * 🚩开始测试
        new TestCommon(TEST_LINES.toString().split("\n"));
    }

    private static final String NAL_LINES = ("' 1-6 stability\n" +
            "" +
            "' file: '1.0.nal'\n" +
